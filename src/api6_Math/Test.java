...
public class Test {
	public static void main(String[] args) {
		...
		// 반올림: Math.round() - 무조건 정수형 반올림(소수 첫째 자리에서 반올림 후 정수로 표시)
		...
		// 소수 첫째자리에서의 반올림: 1234.567 + 0.5 = (int)1234.067 = 1234
		...
		// System.out.println("7.count() : " + Math.count(10,20,30));(X) // 자바에서 개수를 구할때는 length() 또는 size()
		// length(): 문자열 또는 배열, size() : 객체 배열이나 클래스에서 사용, sizeOf(): 바이트수 계산
		System.out.println();
		...
		System.out.println("5~10미만의 난수 : " + ((int)(Math.random()*(10+1-5))+5));
		System.out.println("20~30미만의 난수 : " + ((int)(Math.random()*(30+1-20))+20));
