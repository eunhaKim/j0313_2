...
public class T3_isNull {
	public static void main(String[] args) {
		...
		if(vo.getName() == null) System.out.println("2.vo는 null입니다.");
		else System.out.println("2.vo는 null이 아닙니다.");
		System.out.println();
...
//		vo.setName("홍길동");
		if(Objects.nonNull(vo.getName())) {
			System.out.println("5.vo.name는 "+vo.getName()+"입니다.");
		...
		if(vo.getName().equals("홍길동")) {
			System.out.println("6.vo.name는 "+Objects.requireNonNull(vo.getName())+"입니다.");
//			if(vo.getName().equals("홍길동")) System.out.println("관리자");
//			else System.out.println("방문객");
		}
...
//		System.out.println("7.vo.name는 "+vo.getName()+"입니다.");
		System.out.println("8.vo.name는 "+Objects.requireNonNull(vo.getName())+"입니다.");
	}
}
