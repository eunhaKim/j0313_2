...
public class Test2 {
	public static void main(String[] args) {
		...
		String str3 = "hello1234!!"; // 영문자와 숫자, 기호로 구성
		String str4 = "hello    "; // 영문자와 숫자, 기호로 구성
		String str5 = "안녕"; // 영문자와 숫자, 기호로 구성
		
		if(Pattern.matches(regEx1, str1)) System.out.println("1. 영문자와 숫자로 구성되어 있습니다.");
		else System.out.println("1. 영문자와 숫자가 아인 문자가 포함되어 있습니다.");
		...
		String regEx2 = "^[\\W]*$";
		if(Pattern.matches(regEx2, str3)) System.out.println("11. 영문자와 숫자가 아닌 문자만 포함되어 있습니다.");
