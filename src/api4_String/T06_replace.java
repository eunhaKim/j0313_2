...
public class T06_replace {
	public static void main(String[] args) {
		...
		System.out.println("1.'Korea'를 'USA'로 변경하시오? " + msg1.replace("Korea", "Japan"));
		System.out.println("2.'한국'를 '일본'으로 변경하시오? " + msg2.replace("한국", "일본"));
		System.out.println("3.'o'를 'O'으로 변경하시오? " + msg1.replace("o", "O"));
		System.out.println("4.'o'를 'O'으로 변경하시오? " + msg1.replaceAll("o", "O")); // 검색어에 '정규식'을 사용할때 replaceAll 사용한다.
		System.out.println();
